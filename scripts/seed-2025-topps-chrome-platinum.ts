/**
 * One-off seed: add 2025 Topps Chrome Platinum Anniversary Baseball with its
 * Beckett checklist. Mirrors seed-2025-bowman.ts but scoped to just this one
 ...
 * idempotent.
 *
 *   npx tsx scripts/seed-2025-topps-chrome-platinum.ts
 */
...
const PRODUCTS: Array<{
  ...
  {
    name: "2025 Topps Chrome Platinum Anniversary Baseball",
    sport: "MLB",
    slug: "2025-topps-chrome-platinum-anniversary-baseball-cards",
