/**
 * One-off seed: add 2026 Bowman Chrome Baseball with its Beckett checklist.
 * Mirrors the other seed-YYYY-*.ts scripts — scoped to just this product so
 ...
 *
 *   npx tsx scripts/seed-2026-bowman-chrome.ts
 */
...
const PRODUCTS: Array<{
...
}> = [
  {
    ...
    sport: "MLB",
    slug: "2026-bowman-chrome-baseball-cards",
